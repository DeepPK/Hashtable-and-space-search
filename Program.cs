...
namespace hash_table
{
    ...
    public class HashTable
    {
        ...
        public void Insert(string key, string value)
        {
            ...
            if (_items.ContainsKey(hash))
            {
                ...
                {
                    throw new ArgumentException($"{key} уже существуе, надо бы уникальный.", nameof(key));
                }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            hashTable.Delete("hsxbhfwisrawzfzyhbtanybvzywtvsqhbkmaxoqnswjzrofocwhwzcelyzljlikkqeelekguhcomgyziirmsqlwuuurrjdbwlhpq");
            ShowHashTable(hashTable, "================================Deleted!=========================================================");
            Console.ReadLine();

            Console.WriteLine("ygtueguctywiwmleznjlztmntyjzxishwmtkjymyvmuyylkdhuqhglcorlccxoybixzszzahmmnrgiaehjuqbyjbwkqfdrfwxdnj");
            var text = hashTable.Search("ygtueguctywiwmleznjlztmntyjzxishwmtkjymyvmuyylkdhuqhglcorlccxoybixzszzahmmnrgiaehjuqbyjbwkqfdrfwxdnj");
